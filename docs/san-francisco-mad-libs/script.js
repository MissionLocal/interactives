...
document.addEventListener("DOMContentLoaded", function() {
    ...
    //set my variables
    var pymChild = new pym.Child({'allow': 'clipboard-read; clipboard-write'});
    ...
    function generateStory(selectedStory, textboxes) {
        ...
        if (selectedStory == "nextdoor") {
            ...
            step4.innerHTML = `<hr /> \
                                ...
                                <p>The city where ${inputs[8]} miners flocked in ${inputs[9]} gave way to the Summer of ${toTitleCase(inputs[10])} and hippies with ${inputs[11]} ${inputs[12]} gave way to ${inputs[13]} cults and glass high-rises and tech billionaires and ${inputs[14].toLowerCase()} high on street drugs.</p> \
