    ...
    function generateStory(selectedStory, textboxes) {
        ...
        if (selectedStory == "nextdoor") {
            ...
            step4.innerHTML = `<hr /> \
                                ...
                                <p>It was a devastating blow. And to make matters worse, they left it in the back seat of their car, where it was promptly ${inputs[12].toLowerCase()} by ${inputs[13].toLowerCase()}.</p> \
            ...
            step4.innerHTML = `<hr /> \
                                ...
                                <p>The city where ${inputs[8]} miners flocked in ${inputs[9]} gave way to the Summer of ${toTitleCase(inputs[10])}, and hippies with ${inputs[11]} ${inputs[12]} gave way to ${inputs[13]} cults and glass high-rises and tech billionaires and ${inputs[14]} high on street drugs.</p> \
