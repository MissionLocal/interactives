...
function updateData(measure, datapoints) {
    ...
    headingProg = svg.append("text")
        ...
        .attr("class", "heading")
        .text("Labor and Working Families Slate")
        .style("visibility", "hidden");

    headingMod = svg.append("text")
        .attr("x", width / 2)
        .attr("y", (height / 2) + 20)
        .attr("text-anchor", "middle")
        .attr("font-size", 20)
...
function runSimulation(datapoints) {
    ...
    var simulation = d3
        ...
        .force('y', d3.forceY(d => yPositionScale(d.slate)).strength(yStrength))
...
function popup(d) {
    ...
    var tooltip = d3.select("body")
        ...
        .html("<div class='popup-header'><h4>" +
            ...
            "</div>" +
            "<hr>" + "<p><strong>Contribution date:</strong> " + d.tx_date + "</p>"
