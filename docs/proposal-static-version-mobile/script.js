(function () {
    ...
    const proposals = ["Prop. D","Prop. E"]

    const yPositionScale = d3.scalePoint().domain(proposals).range([100, height+10])
    ...
    // set radius scale
    const radiusScale = d3.scaleSqrt().domain([10, 200000]).range([5, 34])
