...
map.on("load", function () {
    const curranLayer = mapDetailsFunction("curran", "visible", "curran.geojson", "#e54c4c");
    map.addLayer(curranLayer);
    handleLayerClick('curran');
    const santosLayer = mapDetailsFunction("santos", "visible", "santos.geojson", "#0dc1d3");
    map.addLayer(santosLayer);
    handleLayerClick('santos');
    const yuLayer = mapDetailsFunction("yu", "none", "yu.geojson", "#f794d6");
    map.addLayer(yuLayer);
    handleLayerClick('yu');
    const padaLayer = mapDetailsFunction("pada", "none", "pada.geojson", "#83d864");
    map.addLayer(padaLayer);
    handleLayerClick('pada');
});

// checkbox control
function handleCheckboxChange(checkboxId, layerId) {
...
handleCheckboxChange('curran', 'curran');
handleCheckboxChange('santos', 'santos');
handleCheckboxChange('yu', 'yu');
handleCheckboxChange('pada', 'pada');
