...
var type_labels_trimmed = ["Death","Excessive force","Detainment","Hit by vehicle","Employment","Other"]
...
// Set radius scale
const radiusScale = d3.scaleSqrt().domain([0, 13100000]).range([0, 50]);
...
function ready(datapoints) {
  ...
  svg
    ...
    .attr("cx", (d) => d.position_time_mobile_x)
    .attr("cy", (d) => d.position_time_mobile_y)
  ...
  svg
    ...
    .attr("font-size", 15)
    .attr("x", (d) => d.position_time_mobile_x)
    .attr("y", (d) => d.position_time_mobile_y)
    .attr("dx", 25)
  ...
  var xPositionsDepartments = [25, -30, 50];
  ...
  var types = ["Death","Excessive force","Detainment","Hit by vehicle","Employment","Other"]
  var xPositionsTypes = [60, 30, 40, 35, 40, 60];
  var yPositionsTypes = [82, 213, 325, 495, 602, 718];
  svg
    .append("g")
  ...
  var x_axis = d3.axisLeft().scale(yPositionScale);
  svg.append("g")
  ...
  // Create legend
  var n = type_labels_trimmed.length / 3
  var itemWidth = 130
  var itemHeight = 40

  var legend = svg.selectAll(".legend")
    .data(type_labels_trimmed)
    .enter()
    .append("g")
...
function moveCircles(position) {
  ...
  if (position == "department") {
    circles
      .transition()
      .duration(1200)
      .attr("cx", (d) => d.position_department_mobile_x)
      .attr("cy", (d) => d.position_department_mobile_y);
    texts
      .transition()
      .duration(1200)
      .attr("x", (d) => d.position_department_mobile_x)
      .attr("y", (d) => d.position_department_mobile_y);
  ...
  if (position == "type") {
    circles
      .transition()
      .duration(1200)
      .attr("cx", (d) => d.position_type_mobile_x)
      .attr("cy", (d) => d.position_type_mobile_y);
    texts
      .transition()
      .duration(1200)
      .attr("x", (d) => d.position_type_mobile_x)
      .attr("y", (d) => d.position_type_mobile_y);
