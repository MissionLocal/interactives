    ...
    .then(() => {
        ...
        var svg = d3.select("#donut-1-svg")
            ...
            var ring2Color = d3.scaleOrdinal()
                ...
                '#d63c0d', '#d74012', '#d84316', '#d9471b', '#da4b1f', '#db4e24', '#db5228', '#dc562d', '#dd5932', '#de5d36', '#df613b', '#e0643f', '#e16844', '#e26c48', '#e36f4d', '#e47352', '#e57756', '#e57a5b', '#e67e5f', '#e78264', '#e88569', '#e9896d', '#ea8d72', '#eb9076', '#ec947b', '#ed987f', '#ee9b84', '#ef9f89', '#efa38d', '#f0a692', '#f1aa96', '#f2ae9b', '#f3b19f', '#f4b5a4', // 
                '#b5182f', '#b61a31', '#b71c33', '#b81e35', '#b82036', '#b92238', '#ba243a', '#bb263c', '#bc283e', '#bd2a40', '#be2c42', '#be2e43', '#bf3045', '#c03247', '#c13449', '#c2364b', '#c3374d', '#c4394f', '#c43b50', '#c53d52', '#c63f54', '#c74156', '#c84358', '#c9455a', '#ca475c', '#ca495d', '#cb4b5f', '#cc4d61', '#cd4f63', '#ce5165', '#cf5367', '#d05568', '#d0576a', '#d1596c', '#d25b6e', '#d35d70', '#d45f72', '#d56174', '#d56375', '#d66577', '#d76779', '#d8697b', '#d96b7d', '#da6d7f', '#db6f81', '#db7182', '#dc7384', '#dd7486', '#de7688', '#df788a', '#e07a8c', '#e17c8e', '#e17e8f', '#e28091', '#e38293', '#e48495', '#e58697', '#e68899', '#e78a9b', '#e78c9c', '#e88e9e', '#e990a0', '#ea92a2']);  // public works, transport, commerce
